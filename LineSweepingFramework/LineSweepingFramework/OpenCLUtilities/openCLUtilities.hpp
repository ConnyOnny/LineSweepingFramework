...
cl::Program buildProgramFromSourceFile(cl::Context context, std::string filename, std::string buildOptions = "");

cl::Program buildProgramFromSourceString(cl::Context context, std::string source, std::string buildOptions = "");
